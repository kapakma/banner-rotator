...
import { PREFIX, SUPPORT, CSS_ANIMATION_END, CSS_TRANSITION_END } from './util/support';
import { 
	isAndroid, isChrome, getKeys, getTransformProperty, capitalize, getNonNegInt,
	withinRange, isEmptyStr, isNone, getValue, getEasing, isPercent, getInt, getFloat, 
	getPosition, debounce, getPosInt, camelToDash, saveStyle, createWrapper,
